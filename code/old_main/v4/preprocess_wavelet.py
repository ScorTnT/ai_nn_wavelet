...
SAVE_DIR = os.path.join(BASE_PROJECT_DIR, 'wavelet_v4')
...
if __name__ == '__main__':
    print("Starting V4 wavelet preprocessing...")
    ...
    if os.path.exists(SAVE_DIR):
        ...
        # Count complete label distribution
        total_normal = 0
        total_abnormal = 0
        
        print(f"\nCounting complete label distribution...")
    ...
    print(f"\n=== V4 Wavelet Preprocessing Complete ===")
    print(f"Total files processed: {total_processed}")
    print(f"Complete label distribution:")
    print(f"  Normal (0): {total_normal} ({total_normal/total_processed*100:.1f}%)")
    print(f"  Abnormal (1): {total_abnormal} ({total_abnormal/total_processed*100:.1f}%)")
