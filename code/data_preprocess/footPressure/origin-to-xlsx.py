...
# usage example: python3 code/data_preprocess/footPressure/origin-to-total-xlsx.py -i footPressure-/_data/gait-in-parkinsons-disease-1.0.0 -o code/data_preprocess/footPressure/xlsx_output