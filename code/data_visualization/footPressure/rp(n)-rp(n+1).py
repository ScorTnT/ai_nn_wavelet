...
output_folder = r"code/data_visualization/footPressure/_rp(n)-rp(n+1)_v4-512"
os.makedirs(output_folder, exist_ok=True)
# 데이터 초반 몇 초 건너뛸지
skip_seconds = 8

segment_size = 512  # 세그먼트 당 점 개수
# =========================
# 메인 처리
# =========================
...
for fp in sorted(file_list):
    ...
    for i in range(num_segments):
        ...
        # 그래프 저장
        out_path = os.path.join(output_folder, f"{basename}_rp_n-n+1_seg{i+1:02d}.png")
